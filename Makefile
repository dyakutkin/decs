...
pr_c: raylib
ifneq (,$(pr_c_config))
	@echo "==== Building pr_c ($(pr_c_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f pr_c.make config=$(pr_c_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f pr_c.make clean
